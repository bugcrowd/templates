# Incorrect Usage of Cryptography

## Overview
Incorrect usage of cryptography on endpoint allows a malicious attacker to break confidentiality and integrity of requests sent to and from the endpoint.
...
A malicious attacker can view all information sent between the client and the server.
