# Disclosure of Secrets for Intentionally Publicly Sample or Invalid
...
1. Notice following secret was revealed:
...
Sensitive data disclosure of invalid or intentional public samples can enable malicious attackers build wordlists to use for brute forcing requests until a valid secret is processed successfully. 
