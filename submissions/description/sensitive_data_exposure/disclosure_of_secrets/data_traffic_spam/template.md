...
A malicious attacker can leverage Man-in-The-Middle (MiTM) attacks to intercept traffic and disclose secrets for users in applications.
...
1. {{action}} to generate data traffic 

1. Notice the disclosure of sensitive data in the Web Proxy:
...
Data disclosure within data traffic can enable malicious attackers to use secrets for privilege escalation within the application or send API requests on behalf of the user.
