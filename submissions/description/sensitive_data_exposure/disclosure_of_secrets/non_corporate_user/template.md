...
1. Notice on the following endpoint the following secret for a non-corporate user was revealed:
...
Sensitive data disclosure of secrets for non-corporate users can enable malicious attackers login as a user and make requests on their behalf.
