# Sensitive Token Exposed in URL On Password Reset

## Overview

A malicious attacker can use sensitive tokens to escalate privileges or authorize and execute API calls within the application. On password resets would allow attackers to Man-in-The-Middle users to takeover over accounts.
...
Sensitive data disclosure of sensitive tokens in the password reset URL allows attackers to reset a password to one they control and takeover user accounts.
