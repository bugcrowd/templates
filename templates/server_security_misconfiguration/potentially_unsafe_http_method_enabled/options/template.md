...
-->
The OPTIONS HTTP Method is used for applications to recognize the types of HTTP methods that can be used for an endpoint.

A malicious attacker can use OPTION methods to gather information or interact with an endpoint in a way that is unintended.
...
An malicious attacker can use OPTIONS methods to {{value}}
