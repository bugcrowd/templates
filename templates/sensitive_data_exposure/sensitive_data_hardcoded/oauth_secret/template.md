...
A malicious attacker can use hardcoded OAuth secrets to escalate privileges within the application via OAuth workflows.
...
1. {{action}} and notice the OAuth secret is exposed in the request / source code:
