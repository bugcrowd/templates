...
A malicious attacker can leverage disclosed secrets to access the internal application or environments where the application is hosted
...
Sensitive data disclosure of secrets for internal assets can enable malicious attackers to attack and escalate privileges on endpoints that is otherwise non-public.
