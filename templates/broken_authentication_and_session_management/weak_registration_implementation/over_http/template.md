...
## Overview
Weak registration implementation using HTTP allows a malicious attacker to sniif username and password credentials over an unencrypted connection.
...
1. Navigate to Bugcrowd.com/registration

{{screenshot}}

1. {{action}} and view in Web Proxy to see that credentials are sent through HTTP
...
A malicious attacker can sniff usernames and passwords through the registration portal.
