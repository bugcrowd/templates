# Sensitive Data Hardcoded Filepaths

## Overview

A malicious attacker can use hardcoded filepaths to request files from the underlying system via directory traversal.
...
1. {{action}} and notice the filepath is exposed in the request / source code:
...
Sensitive data disclosure of internal filepaths allows malicious attackers to traverse the application and expose data such as filenaming conventions, system admin users, and permissions on the system.
