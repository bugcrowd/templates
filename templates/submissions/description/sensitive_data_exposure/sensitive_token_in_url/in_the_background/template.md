...
A malicious attacker can use sensitive tokens to escalate privileges or authorize API calls within the application.
...
Sensitive data disclosure of sensitive tokens in the URL allows attackers to make calls to services and applications they otherwise would not have access to.
